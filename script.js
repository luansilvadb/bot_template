function criarBarra(var_nome, var_avatar) {
  ...
  audioNot.src = 'https://s3.seunegocioautomatico.com/templates/whatsapp/audio_whatsapp.mp3';
  ...
  if (!document.getElementById(cssId))
  {
      ...
      link.rel  = 'stylesheet';
      link.type = 'text/css';
      link.href = 'https://raw.githubusercontent.com/luansilvadb/bot_template/main/style.css';
      link.media = 'all';
